...
public class HomePage2Activity extends AppCompatActivity implements View.OnClickListener,OnMapReadyCallback  {
    ...
    MapRadar mapRadar;
    private Context context = HomePage2Activity.this;
